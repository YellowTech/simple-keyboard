...
import yellowtech.simplekeyboardwithemojis.inputmethod.latin.common.UnicodeSurrogate;
import yellowtech.simplekeyboardwithemojis.inputmethod.latin.settings.SpacingAndPunctuations;
import yellowtech.simplekeyboardwithemojis.inputmethod.latin.utils.CapsModeUtils;
import yellowtech.simplekeyboardwithemojis.inputmethod.latin.utils.DebugLogUtils;
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            for (final CharacterStyle span : spans) {
                ...
                // See yellowtech.simplekeyboardwithemojis.inputmethod.latin.common.Constants.UnicodeSurrogate
